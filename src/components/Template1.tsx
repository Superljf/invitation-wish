...
export function Template1({ data }: Props) {
  return (
    <div className="w-[360px] h-[600px] bg-zhong-red rounded-xl shadow-xl p-8 flex flex-col items-center justify-between text-zhong-gold overflow-hidden" style={{ fontFamily: data.nameFont }}>
